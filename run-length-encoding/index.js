...
stored as a single data value and count, rather than as the original run. Wikipedia
...
replicating the character sx ix times and concatening all those strings. Your run-length encoding should
be minimal, ie. for all i the values si and si+1 should differ.
...
const runLengthEncoding = (str) => {
	...
	return items.map((item) => [item.length, item[0]]);
};
